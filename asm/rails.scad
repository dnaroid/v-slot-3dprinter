...
rails_asm()
{
    ...
    Rx(180) rail_assembly(railX_type, railX_l, car_x);
    ...
    T(car_x, car_y + railY_yo - 10, 22 - 24)
    Cu(30, 40, 3);

    // left Z
    T(-hpl, bed_yo, -railZ_l / 2 - railZ_zo)
    Ry(90) rail_assembly(railZ_type, railZ_l, -railZ_l / 2 - caretZ_o - bed_z);
