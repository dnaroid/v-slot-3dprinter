...
MGN9H_carriage = [ 39.9, 29.9, 20, 10, 2,   10, 15, M3_cap_screw ];
...
MGN9H= [ "MGN9H", 9,  6,   7.5, 20, 6.0, 3.5, 3.5, M3_cap_screw,    MGN9H_carriage, M3_cs_cap_screw ];
...
rails = [MGN5, MGN7, MGN9, MGN9H, MGN15, SSR15];
