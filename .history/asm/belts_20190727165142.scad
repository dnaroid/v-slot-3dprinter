...
module draw_belt(from, to, angles) {
  a = angle(from, to) - 90;
  echo("-----angle");
  echo(a);
  color("black")
...
module belts_asm() {
  ...
  pulleys = [
    [motorXY_x, motorXY_y, pz, GT2x20um_pulley, [90, 90], true], // motor L

    // [pxo, py, pz, Ti], // corn FL
    [long, -short, pz, Ti, [90, 180]], // corn BL


    [-pxi, -py, pz, Ti, [180, 180]], // corn BR inner
