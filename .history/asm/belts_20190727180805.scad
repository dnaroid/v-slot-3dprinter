...
module belts_asm() {
  ...
  pulleys = [
    ...
    [-motorXY_x, -short, pz, Ti, [-90, 180]], // corn BR inner
    [-motorXY_x, car_y - car_yo + railY_yo, pz, Ti, [180, 90]], // car
    [motorXY_x, car_y - car_yo + railY_yo, pz, Ti, [90, 0]], // car
    [motorXY_x, -short, pz, Ti, [0, -90]], // corn BL inner
    [-long, -short, pzu, Ti, [-90, 180]], // corn BR
    [-motorXY_x, motorXY_y, pz, Ti, [180, 0]], // motor R
    [-motorXY_x, car_y + car_yo + railY_yo, pz, Ti, [180, -90]], // car
    [motorXY_x, car_y + car_yo + railY_yo, pz, Ti, [-90, 0]], // car
    [motorXY_x, motorXY_y, pz, undef, [180, 0], true],
  ];
