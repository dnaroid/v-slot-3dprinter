module belts_asm() {
  ...
  p1 = [motorXY_x, motorXY_y, topPulleys_z, GT2x20_toothed_idler]; // motor L
  p2 = [hpl - hpt, hpl - 10, topPulleys_z, GT2x20_toothed_idler];
  p3 = [hpl - hpt, hpl - 10, topPulleys_z, GT2x20_toothed_idler];
