module bed_asm() {
  ...
  pulleys = [
    [-screw_xo, bed_yo, screw_z - screw_l + 24, GT2x20_toothed_idler, [0, -90]], // motor L
    [screw_xo, bed_yo, screw_z - screw_l + 24, GT2x20_toothed_idler, [-90, 0]], // motor L
    [40, bed_yo, screw_z - screw_l + 24, GT2x20_toothed_idler, [-90, 0]], // motor L
  ];
