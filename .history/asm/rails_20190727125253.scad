module rails_asm() {
  ...
  // X
  D(
    T(-profile_l / 2, car_y - railY_car_l / 2 + railY_yo, railY_car_h) cube([profile_l, railY_car_l, railX_support_t]),
    T(-railX_l / 2, car_y - railY_car_l / 2, railY_car_h - 5) cube([railX_l, railY_car_l, railX_support_t + 10])
  )
